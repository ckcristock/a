  ...
  realizarRecaudo() {
    ...
    SwalMsje.fire({
      ...
      if (result.isConfirmed) {
        ...
        this._recaudoServiceService.saveFees(this.recaudo).subscribe((resp: any) => {
          functionsUtils.validateCodeCreate(resp)
          this.ModalPayment.hide();
          functionsUtils.SwalMsje('Cuota Recaudada', 'La cuota/copago fue recaudada correctamente!', 'success')
