...
export class CategoriasComponent implements OnInit {
  ...
  ngOnInit(){
    this.http.get(environment.ruta + 'php/genericos/departamentos.php', {params: { modulo: 'Departamento'}
  }).subscribe((data: any) => {
    // console.log(data);
  ...
  this.http.get(environment.ruta + 'php/categoria_nueva/detalle_categoria_nueva_departamento.php').subscribe((data: any) => {
  ...
  this.columns = [
    ...
    { prop: 'Direccion' },
    { prop: 'Telefono' },
    { cellTemplate: this.PlantillaBotones, prop: 'Id_Categoria_Nueva', name: 'Acciones', sortable: false, maxWidth: '110' },
  ]
  ...
  GuardarCategoria(formulario: NgForm, modal) {
    ...
    modal.hide();
    this.http.post(environment.ruta + 'php/categoria_nueva/guardar_categoria_nueva.php', datos).subscribe((data: any) => {
      formulario.reset();
  ...
  EditarCategoria(id) {
    this.http.get(environment.ruta + 'php/categoria_nueva/detalle_categoria_nueva.php', {
      params: { id: id }
  ...
  EliminarCategoria(id) {
    ...
    datos.append("modulo", 'Categoria');
    datos.append("id", id);
    this.http.post(environment.ruta + 'php/categoria_nueva/eliminar_categoria_nueva.php', datos).subscribe((data: any) => {
  ...
  Listarcategorias() {
    this.http.get(environment.ruta + 'php/categoria_nueva/detalle_categoria_nueva_general.php').subscribe((data:any) => {
  ...
  paginacion() {
    ...
    this.http.get(environment.ruta + '/php/categoria_nueva/detalle_categoria_nueva_general.php?pag='+this.page).subscribe((data: any) => {
      this.categorias = data.Categorias;
  ...
  filtros() {
    ...
    if (this.filtro_categoria != "" || this.filtro_departamento != "" || this.filtro_municipio != "" || this.filtro_direccion != "" || this.filtro_telefono != "") {
      this.page = 1;
      ...
      this.http.get(environment.ruta + 'php/categoria_nueva/detalle_categoria_nueva_general.php?'+queryString).subscribe((data: any) => {
        // console.log(data);
        this.categorias = data.Categorias;
        this.TotalItems = data.numReg;
      });
  ...
  cargarSubcategorias() {
    this.http.get(environment.ruta+'php/subcategoria/get_subcategorias.php').subscribe((data:any) => {
