...
export class ClientesComponent implements OnInit {
  ...
  @ViewChild("modalNewAgent") modalNewAgent;
  public newAgent: any = {
    Id_Cliente: "",
    Nombres: "",
    Apellidos: "",
  ...
  ngOnInit() {
    ...
    this.http
      .get(environment.ruta + "php/clientes/lista_zona.php")
      .subscribe((data: any) => {
        this.Zonas = data;
      });
  }

  buscarIdentificacion(identificacion) {
  ...
  paginacion() {
    ...
    this.http
      .get(
        environment.ruta + "/php/clientes/lista_clientes.php?" + queryString
      )
      .subscribe((data: any) => {
        this.Cargando = false;
        this.clientes = data.clientes;
  ...
  getAgents(Id_Cliente) {
    this.http
      .get(
        environment.ruta + "php/clientes/agentes_clientes/get_agentes.php",
        { params: { Id_Cliente } }
      )
      .subscribe((res) => {
	this.agents = res;
