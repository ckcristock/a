...
export class ClientecrearComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.paramsIdCliente()) { // Si viene un parametro en la URL se pregunta si es el Id de Cliente y/o se obtiene.
  ...
  getDatosCLiente(id) {
    ...
    this.http.get(environment.ruta+'php/clientes/detalle_cliente.php',{params:{id:id}}).subscribe((data:any)=>{
  ...
  ListarMunicipios() {
    ...
    this.http.get(environment.ruta+'php/proveedores/lista_municipios.php', { params: { id_dep: this.Model.Id_Departamento.value } }).subscribe((data:any)=>{
  ...
  guardarCliente() {
    ...
    this.http.post(environment.ruta+'php/clientes/guardar_cliente.php', datos).subscribe((data:any)=>{
