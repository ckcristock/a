...
export class ElectronicPayrollsService {
  ...
  getPayrolls(id) {
    return this.http.get(
      `${environment.base_url}/electronic-payroll-paginate/${id}`
    );
  }

  getStatistcs(id) {
    return this.http.get(
      `${environment.base_url}/electronic-payroll-statistics/${id}`
    );
  }
  ...
  reportAllElectronic(id) {
    return this.http.post(
      `${environment.base_url}/payroll/report-electronic/${id}`,
      {}
    );
  }
