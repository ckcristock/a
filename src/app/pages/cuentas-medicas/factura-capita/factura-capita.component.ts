...
export class FacturaCapitaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get(environment.ruta + 'php/tablero_jefe_facturacion/grafica_facturas.php').subscribe((data: any) => {
  ...
  cargarIndicadores() {
    this.http.get(environment.ruta + 'php/tablero_jefe_facturacion/indicadores_jefe_facturacion.php').subscribe((data: any) => {
  ...
  ListarDetallesFacturacion() {
    ...
    this.http.get(environment.ruta + '/php/tablero_jefe_facturacion/lista_facturas.php' + queryString).subscribe((data: any) => {
  ...
  filtros1() {
    ...
    if (this.filtro_cod_fact != "" || this.filtro_fecha_fact != "" || this.filtro_estado_fact != "" || this.filtro_facturador != "" || this.filtro_cliente != "" || this.filtro_tipo_fact != "") {
      ...
      this.http.get(environment.ruta + '/php/tablero_jefe_facturacion/lista_facturas.php').subscribe((data: any) => {
        this.Facturas = data.Facturas;
        this.TotalItems1 = data.numReg;
      });
    }
  ...
  cargarPuntos(id_dep) {
    ...
    if (id_dep != "") {
      this.http.get(environment.ruta + 'php/reportes/puntos.php', { params: { id_dep: id_dep } }).subscribe((data: any) => {
        this.Puntos = data;
      })
    }
  }
  ...
  downloadReporte() {
    ...
    window.open(environment.ruta + 'php/dispensaciones/reporte_disp_excel.php' + queryString, '_blank');
  ...
  downloadReporteFacturacion() {
    ...
    window.open(environment.ruta + 'php/tablero_jefe_facturacion/reporte_facturacion.php' + queryString, '_blank');

  }

  listaCausalAnulacion() {
    this.http.get(environment.ruta + 'php/tablero_jefe_facturacion/lista_causal_anulacion.php').subscribe((data: any) => {
  ...
  AnularFactura(formulario) {
    ...
    this.http.post(environment.ruta + 'php/tablero_jefe_facturacion/anular_factura.php', datos).subscribe((data: any) => {
