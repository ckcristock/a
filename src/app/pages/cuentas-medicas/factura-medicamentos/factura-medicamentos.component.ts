...
export class FacturaMedicamentosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get(environment.ruta + 'php/auditorias/lista_auditores.php').subscribe((data: any) => {
  ...
  ListarDispensacionesAuditoria() {
    ...
    this.http.get(environment.ruta + '/php/dispensaciones/lista_dispensaciones_auditoria.php' + queryString).subscribe((data: any) => {
  ...
  filtros() {
    ...
    if (this.filtro_cod != "" || this.filtro_fecha != "" || this.filtro_tipo != "" || this.filtro_facturador != "" || this.filtro_estado != "" || this.filtro_cliente != "") {
      ...
      this.http.get(environment.ruta + '/php/dispensaciones/lista_dispensaciones_auditoria.php').subscribe((data: any) => {
        this.Dispensaciones = data.dispensaciones;
        this.TotalItems = data.numReg;
        this.Cargando = false;
  ...
  ListarDetallesFacturacion() {
    ...
    this.http.get(environment.ruta + '/php/facturasventas/detalle_factura.php' + queryString).subscribe((data: any) => {
  ...
  filtros1() {
    ...
    if (this.filtro_cod_fact != "" || this.filtro_fecha_fact != "" || this.filtro_estado_fact != "") {
      ...
      this.http.get(environment.ruta + '/php/facturasventas/detalle_factura.php').subscribe((data: any) => {
        this.Productos = data.productos;
        this.TotalItems1 = data.numReg;
      });
    }
  ...
  AsignarFacturador(formulario: NgForm, modal) {
    ...
    modal.hide();
    this.http.post(environment.ruta + 'php/facturasventas/asignar_facturador.php', datos).subscribe((data: any) => {
      formulario.reset();
  ...
  guardarAsignaciones(formulario: NgForm, modal) {
    ...
    modal.hide();
    this.http.post(environment.ruta + '/php/facturasventas/guardar_factura_dispensacion.php', datos).subscribe((data: any) => {
      formulario.reset();
