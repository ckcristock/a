...
export class AlistamientoComponent implements OnInit {
  ...
  filtros() {
    ...
    if (
      ...
      this.http
        .get(environment.ruta + 'php/alistamiento/detalle_alistamiento.php')
        .subscribe((data: any) => {
          this.Alistamientos = data.remisiones;
          this.loading = false
          this.TotalItems = data.numReg;
  ...
  Bandera_Fase1(id, tipo, idc) {
    ...
    this.http
      .get(environment.ruta + 'php/alistamiento/guardar_hora_inicio.php', {
        params: {
          id: id,
          mod,
  ...
  GuardarGuiaRemision() {
    ...
    this.http
      .post(
        environment.ruta + 'php/alistamiento/guardar_guia_remisiond.php',
        datos
      )
      .subscribe((data: any) => {
