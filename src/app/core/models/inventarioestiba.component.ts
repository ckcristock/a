...
import { InventarioFisicoModel } from '../../shared/modelos/InventarioFisicoModel';
import { GeneralService } from '../../shared/services/general/general.service';
import { SwalService } from '../../shared/services/swal/swal.service';
import { ToastService } from '../../shared/services/toasty/toast.service';
import { InventariofisicoService } from '../../shared/services/inventariofisico/inventariofisico.service';
...
@Component({
  ...
  templateUrl: './inventarioestiba.component.html',
  styleUrls: ['./inventarioestiba.component.scss']
})
export class InventarioestibaComponent implements OnInit {
  ...
  ValidarLote(pos) {
    ...
    if (this.Producto_Barras['Lotes'][pos].Lote.length < 4) {
      ...
      let swal = {
        codigo: "error",
        titulo: "Error en Lote",
        mensaje: "La longitud del Lote debe ser mayor o igual a tres letras"
      };
      this._swalService.ShowMessage(swal);
  ...
  ValidarFecha(pos) {
    ...
    if (this.Producto_Barras['Lotes'][pos].Fecha_Vencimiento < Fecha_Inferior || this.Producto_Barras['Lotes'][pos].Fecha_Vencimiento > Fecha_Superior) {
      let swal = {
        ...
        mensaje: "Hay un error en la fecha de  vencimiento, por favor revise "
      };
      this._swalService.ShowMessage(swal);
